// ===== TRAINER PAGE – REBRANDED FOR DAILY DOZE GYM =====
(function() {
  const API_BASE = '/api';

  // ===== PWA INSTALL PROMPT LOGIC (trainer app) – FIXED ID =====
  let deferredTrainerPrompt;
  const installTrainerBtn = document.getElementById('installTrainerAppBtn'); // Fixed ID
    ...
    container.innerHTML = trainers.map(t => `
      <div class="leader-card" data-trainer-id="${t._id}">
        ...
        <div class="trainer-socials">
          <a href="https://wa.me/${t.whatsappNumber}?text=Hi%2C%20${encodeURIComponent(t.name)}%20I%20want%20to%20join%20Daily%20Doze%20Gym" target="_blank" class="social-icon whatsapp"><i class="fab fa-whatsapp"></i></a>
      ...
      btn.addEventListener('click', () => {
        ...
        showModal(`
          <div style="text-align:center;">
            ...
            <h2 style="color:#FF6B00;">${trainer.name}</h2>
  ...
  function renderContactInfo() {
    ...
    if (waLink && contactInfo.whatsappNumber) waLink.href = `https://wa.me/${contactInfo.whatsappNumber}?text=Hi%2C%20I%20want%20to%20join%20Daily%20Doze%20Gym`;
